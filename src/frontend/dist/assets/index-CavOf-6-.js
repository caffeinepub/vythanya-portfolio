...
const highlights = [
  ...
  { icon: CodeXml, label: "Core Skill", value: "C Programming" },
...
function About() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", ref, className: "py-24 bg-muted/30 opacity-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent text-sm font-semibold uppercase tracking-widest mb-2", children: "Who I Am" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold text-foreground", children: "About Me" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto grid lg:grid-cols-2 gap-10 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-8 shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-foreground text-base leading-relaxed mb-4", children: [
          "Currently pursuing a B.Tech in Artificial Intelligence and Machine Learning at",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-medium", children: "Geetanjali College of Engineering and Technology" }),
          ", Hyderabad, Telangana, India. I have a deep passion for coding practice, especially recursion and string manipulation in C."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base leading-relaxed mb-4", children: "I am enthusiastic about academic productivity tools, creating slide decks and PPTs for structured learning. My curiosity drives me to explore AI/ML concepts beyond the classroom and connect them to real-world applications." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base leading-relaxed", children: "Eager to contribute to student projects and help fellow learners grow through online tutoring in C programming and engineering fundamentals. I believe great things happen when curiosity meets consistency." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: highlights.map(({ icon: Icon2, label, value }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "bg-card border border-border rounded-xl p-5 hover-lift text-center",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-accent/10 flex items-center justify-center mx-auto mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-5 w-5 text-accent" }) }),
...
var ve = (n) => {
  ...
  }, className: M$1(s == null ? void 0 : s.cancelButton, (At = t == null ? void 0 : t.classNames) == null ? void 0 : At.cancelButton) }, t.cancel.label) : null, reactExports.isValidElement(t.action) ? t.action : t.action && tt(t.action) ? o.createElement("button", { "data-button": true, "data-action": true, style: t.actionButtonStyle || l, onClick: (r2) => {
    var m, c;
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", ref, className: "py-24 bg-muted/30 opacity-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent text-sm font-semibold uppercase tracking-widest mb-2", children: "Let's Connect" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold text-foreground", children: "Get In Touch" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto grid lg:grid-cols-2 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-6 shadow-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-semibold text-foreground mb-4", children: "Contact Details" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-accent/10 flex items-center justify-center group-hover:bg-accent/20 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 text-accent" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "break-all", children: "vythanyasree2008@gmail.com" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-accent/10 flex items-center justify-center group-hover:bg-accent/20 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "h-4 w-4 text-accent" }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-accent/10 flex items-center justify-center group-hover:bg-accent/20 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { className: "h-4 w-4 text-accent" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "GitHub Profile" })
                ]
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-primary/10 to-accent/10 border border-primary/20 rounded-2xl p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground font-medium mb-1", children: "Open to opportunities" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "Looking for study collaborations, tutoring opportunities, or student project partnerships. Don't hesitate to reach out!" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-2xl p-7 shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, noValidate: true, className: "space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          errors.name && touched.name && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-destructive mt-1 flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          errors.email && touched.email && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-destructive mt-1 flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3 w-3" }),
            errors.email
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          errors.message && touched.message && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-destructive mt-1 flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3 w-3" }),
            errors.message
          ] })
        ] }),
...
const educationItems = [
  {
    ...
    description: "Pursuing foundational and advanced topics in AI, machine learning, data structures, and C programming. Active participant in academic workshops and peer learning groups.",
    status: "current"
  }
];
const experienceItems = [
  {
    ...
    description: "Exploring online tutoring opportunities to help fellow students master C programming concepts, recursion, pointer manipulation, and engineering fundamentals. Open to collaborative student projects.",
    status: "exploring"
  }
];
function Education() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "education", ref, className: "py-24 bg-muted/30 opacity-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent text-sm font-semibold uppercase tracking-widest mb-2", children: "Background" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold text-foreground", children: "Education & Experience" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-6", children: [
      educationItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "bg-card border border-border rounded-2xl p-7 shadow-card hover-lift",
          "data-ocid": "education-card",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "h-6 w-6 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold bg-primary/10 text-primary border border-primary/20 px-2 py-0.5 rounded-full", children: item.type }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold bg-accent/10 text-accent border border-accent/20 px-2 py-0.5 rounded-full capitalize", children: item.status })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-foreground mb-0.5", children: item.degree }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent font-medium text-sm mb-2", children: item.institution }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-accent mt-2 font-medium", children: item.detail })
            ] })
          ] })
        },
        item.degree
      )),
      experienceItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "bg-card border border-border rounded-2xl p-7 shadow-card hover-lift",
          "data-ocid": "experience-card",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "h-6 w-6 text-accent" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold bg-accent/10 text-accent border border-accent/20 px-2 py-0.5 rounded-full", children: item.type }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold bg-muted text-muted-foreground border border-border px-2 py-0.5 rounded-full capitalize", children: item.status })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-foreground mb-0.5", children: item.role }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent font-medium text-sm mb-2", children: item.focus }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-x-4 gap-y-1 text-xs text-muted-foreground mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-3 w-3" }),
                item.duration
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: item.description })
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground", children: "Guduru Vythanya Sree" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Aspiring AI/ML Engineer" })
    ] }),
...
function Hero() {
  ...
  reactExports.useEffect(() => {
    var _a2;
    (_a2 = containerRef.current) == null ? void 0 : _a2.classList.add("fade-in");
  }, []);
  const scrollToSkills = () => {
    var _a2;
    (_a2 = document.getElementById("skills")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
  };
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none", "aria-hidden": "true", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-3xl" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/4 right-1/4 w-80 h-80 bg-accent/10 rounded-full blur-3xl" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row items-center gap-12 lg:gap-20", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 fade-in-delay-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-48 h-48 lg:w-56 lg:h-56", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-gradient-to-br from-primary/40 to-accent/40 blur-xl" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full h-full rounded-full border-4 border-accent/40 overflow-hidden shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center lg:text-left max-w-2xl", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-accent/10 border border-accent/20 text-accent text-xs font-medium px-3 py-1 rounded-full mb-4 fade-in-delay-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-3 w-3" }),
                  "Open to projects & tutoring opportunities"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl lg:text-6xl font-bold text-foreground mb-3 leading-tight fade-in-delay-1", children: "Guduru Vythanya Sree" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent font-semibold text-lg lg:text-xl mb-4 fade-in-delay-2", children: "Aspiring AI/ML Engineer | C Programming Enthusiast" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base lg:text-lg leading-relaxed mb-8 fade-in-delay-2", children: "Passionate about AI, machine learning, and foundational engineering. Skilled in C programming, and building efficient algorithms. Exploring online tutoring and student projects." }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 justify-center lg:justify-start fade-in-delay-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-6 w-6" })
          }
        )
      ]
    }
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-smooth ${scrolled ? "bg-card/95 backdrop-blur-md border-b border-border shadow-card" : "bg-transparent"}`,
      "data-ocid": "navbar",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              children: [
                NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: `px-4 py-2 rounded-md text-sm font-medium transition-smooth relative group ${activeSection === link.href.slice(1) ? "text-accent" : "text-muted-foreground hover:text-foreground"}`,
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: `absolute bottom-1 left-4 right-4 h-0.5 rounded-full bg-accent transition-smooth ${activeSection === link.href.slice(1) ? "opacity-100" : "opacity-0 group-hover:opacity-50"}`
                        }
                      )
                    ]
                  },
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-card/98 backdrop-blur-md border-b border-border shadow-card py-4", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => scrollTo(link.href),
            className: `w-full text-left px-6 py-3 text-sm font-medium transition-smooth ${activeSection === link.href.slice(1) ? "text-accent" : "text-muted-foreground hover:text-foreground"}`,
...
const projects = [
  {
    ...
    description: "Visualizes sorting algorithms — bubble, selection, and merge sort — step-by-step using C logic explained with animated walkthroughs and detailed commentary on time complexity.",
  ...
  },
  {
    ...
    description: "A personal learning journal tracking AI/ML concepts, with structured notes on datasets, algorithm comparisons, experiment outcomes, and progress milestones.",
  ...
  },
  {
    ...
    description: "A dashboard to track daily study goals, task completion, and academic progress. Visualizes weekly trends, subject-wise time distribution, and milestone achievements.",
...
function ProjectCard({ project, index: index2 }) {
      ...
      (entries) => {
        for (const entry of entries) {
          if (entry.isIntersecting && ref.current) {
            setTimeout(() => {
              var _a2;
              (_a2 = ref.current) == null ? void 0 : _a2.classList.add("fade-in");
            }, index2 * 100);
            observer.unobserve(entry.target);
          }
        }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": `project-card-${index2}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-gradient-to-br from-primary/20 to-accent/20 border border-accent/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(project.icon, { className: "h-6 w-6 text-accent" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-foreground mb-2", children: project.title }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-accent font-medium mb-4 flex items-center gap-1.5", children: [
...
function Projects() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "py-24 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: headerRef, className: "text-center mb-14 opacity-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent text-sm font-semibold uppercase tracking-widest mb-2", children: "What I've Built" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold text-foreground", children: "Projects" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto grid md:grid-cols-3 gap-6", children: projects.map((project, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectCard, { project, index: i }, project.title)) })
  ] }) });
}
...
function SkillBarItem({ name, level, label }) {
...
function SkillCategory({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-6 shadow-card hover-lift", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-accent uppercase tracking-wider mb-4", children: title }),
    skills.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkillBarItem, { ...s }, s.name))
  ] });
}
function Skills() {
  const ref = reactExports.useRef(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", ref, className: "py-24 bg-background opacity-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent text-sm font-semibold uppercase tracking-widest mb-2", children: "What I Know" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl lg:text-4xl font-bold text-foreground", children: "Skills" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SkillCategory, { title: "AI / ML", skills: aiMlSkills })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SkillCategory, { title: "Tools & Platforms", skills: toolSkills }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-6 shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-accent uppercase tracking-wider mb-4", children: "Soft Skills" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: softSkills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
          {
